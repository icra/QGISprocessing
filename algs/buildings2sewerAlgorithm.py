...
class buildings2sewerAlgorithm(QgsProcessingAlgorithm):
    """
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if parcels_o.crs() != nodes_o.crs() or parcels_o.crs() != mde.crs():
            feedback.reportError("Layers do not have the same EPSG")
            return {}
    ...
    def createInstance(self):
        return buildings2sewerAlgorithm()
